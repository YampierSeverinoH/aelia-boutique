...
class OfferResource extends Resource
{
    ...
    protected static UnitEnum|string|null $navigationGroup = 'Contenido y Banners';

    protected static ?string $modelLabel = 'Sección de Oferta';

    protected static ?string $pluralModelLabel = 'Sección de Ofertas';
